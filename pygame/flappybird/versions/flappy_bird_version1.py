...
# Bird screen position at start of game
bird_width_height = [75, 100]  # set size for player sprite
bird_image_transform = pygame.transform.scale(BIRD_IMAGE, bird_width_height)  # modifies size of image
bird_x_position, bird_y_position = SCREENWIDTH//2, SCREENHEIGHT//2    #X,Y for centre
